...
hiDraw.prototype.ContinuePath = (function() {
    function Path(canvasItem, options, otherProps) {
        this.canvasItem = canvasItem;
        this.canvas = canvasItem.canvasView;
        this.options = { 
    ...
    Path.prototype.changeOptions = function (options) {
        var inst = this;
        if (options) {
            inst.options = inst.mergeDeep(inst.options, options);
        }
        // change color
        var brush = inst.canvas.freeDrawingBrush;
        brush.color = inst.options.brush.color;
    }

    Path.prototype.mergeDeep = function (target, source) {
