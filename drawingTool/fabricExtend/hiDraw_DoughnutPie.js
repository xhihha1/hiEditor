(function (global) {
  ...
  if (fabric.DoughnutPie) {
    fabric.warn('fabric.DoughnutPie is already defined');
    return;
  }
...
fabric.DoughnutPie = new fabric.util.createClass(fabric.Rect, {
  ...
  hiDraw.prototype.DoughnutPie = (function () {
    ...
    Circle.prototype.onMouseDown = function (o) {
      ...
      //     strokeUniform: true
      // });
      var ellipse = new fabric.DoughnutPie({
        // stroke: '#333333',
        // strokeWidth: 2,
