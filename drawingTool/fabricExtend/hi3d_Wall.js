(function (global) {
  ...
  if (fabric.HiWall) {
    fabric.warn('fabric.HiWall is already defined');
    return;
  }


  fabric.HiWall = fabric.util.createClass(fabric.Rect, {
  ...
  fabric.HiWall.fromObject = function (object, callback) {
    callback && callback(new fabric.HiWall(object));
  };

  fabric.HiWall.async = true;

  // fabric.HiWall.prototype.controls = {
  ...
  // }
  // urgent
  fabric.HiWall.prototype.controls = fabric.Object.prototype.controls;


  hiDraw.prototype.HiWall = (function () {
