(function (global) {
  ...
  // ---------------------------------------
  fabric.HiFormatObj.prototype.controls = {}
  fabric.HiFormatObj.prototype.controls.tl = new fabric.Control({
    x: -0.5,
    y: -0.5,
  ...
  fabric.HiFormatObj.prototype.controls.tr = new fabric.Control({
    x: 0.5,
    y: -0.5,
    // cursorStyleHandler: scaleStyleHandler,
    // actionHandler: wrapWithFireEvent('scaling', wrapWithFixedAnchor( scaleObject))
  ...
  fabric.HiFormatObj.prototype.controls.bl = new fabric.Control({
    x: -0.5,
    y: 0.5,
    // cursorStyleHandler: scaleStyleHandler,
    // actionHandler: wrapWithFireEvent('scaling', wrapWithFixedAnchor( scaleObject))
  ...
  fabric.HiFormatObj.prototype.controls.br = new fabric.Control({
    x: 0.5,
    y: 0.5,
    // cursorStyleHandler: scaleStyleHandler,
    // actionHandler: wrapWithFireEvent('scaling', wrapWithFixedAnchor( scaleObject))
  ...
  fabric.HiFormatObj.prototype.controls.mtr = new fabric.Control({
    x: 0,
    y: -0.5,
