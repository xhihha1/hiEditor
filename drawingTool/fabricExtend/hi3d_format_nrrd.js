(function (global) {
  ...
  if (fabric.HiFormatNrrd) {
    fabric.warn('fabric.HiFormatNrrd is already defined');
    return;
  }

  fabric.HiFormatNrrd = fabric.util.createClass(fabric.Rect, {
    ...
    _render: function (ctx) {
      ...
      ctx.font = "16px Arial";
      ctx.fillText("stl", 0, 0);

    }
  });

  fabric.HiFormatNrrd.fromObject = function (object, callback) {
    callback && callback(new fabric.HiFormatNrrd(object));
  };

  fabric.HiFormatNrrd.async = true;

  // ---------------------------------------
  fabric.HiFormatNrrd.prototype.controls = {}
  fabric.HiFormatNrrd.prototype.controls.tl = new fabric.Control({
    x: -0.5,
    y: -0.5,
  ...
  fabric.HiFormatNrrd.prototype.controls.tr = new fabric.Control({
    x: 0.5,
    y: -0.5,
    // cursorStyleHandler: scaleStyleHandler,
    // actionHandler: wrapWithFireEvent('scaling', wrapWithFixedAnchor( scaleObject))
  ...
  fabric.HiFormatNrrd.prototype.controls.bl = new fabric.Control({
    x: -0.5,
    y: 0.5,
    // cursorStyleHandler: scaleStyleHandler,
    // actionHandler: wrapWithFireEvent('scaling', wrapWithFixedAnchor( scaleObject))
  ...
  fabric.HiFormatNrrd.prototype.controls.br = new fabric.Control({
    x: 0.5,
    y: 0.5,
    // cursorStyleHandler: scaleStyleHandler,
    // actionHandler: wrapWithFireEvent('scaling', wrapWithFixedAnchor( scaleObject))
  ...
  fabric.HiFormatNrrd.prototype.controls.mtr = new fabric.Control({
    x: 0,
    y: -0.5,
  ...
  hiDraw.prototype.HiFormatNrrd = (function () {
    ...
    Circle.prototype.onMouseDown = function (o) {
      ...
      // this.source = {}  // obj: url
      var ellipse = new fabric.HiFormatNrrd(prop)
