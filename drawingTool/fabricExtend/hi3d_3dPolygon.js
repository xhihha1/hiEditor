(function(global) {
  ...
  if (fabric.Hi3DPolygon) {
    fabric.warn('fabric.Hi3DPolygon is already defined');
    return;
  }

fabric.Hi3DPolygon = fabric.util.createClass(fabric.Polygon, {
...
fabric.Hi3DPolygon.fromObject = function (object, callback) {
  callback && callback(new fabric.Hi3DPolygon(object.points, object));
};

fabric.Hi3DPolygon.async = true;

// fabric.Hi3DPolygon.prototype.controls = {}

fabric.Hi3DPolygon.prototype.controlsGenerator = function (polygon) {
...
fabric.Hi3DPolygon.prototype.polygonAddPoints = function (polygon) {
  // custom control
...
hiDraw.prototype.Hi3DPolygon = (function () {
  ...
  Polygon.prototype.generatePolygon = function (pointArray) {
    ...
    polygon.hiId = hiDraw.prototype.uniqueIdGenerater()
    polygon.altitude = 0
    polygon.scaleZ = 1
    polygon.scaleZ = 1
    polygon.depth = 1
