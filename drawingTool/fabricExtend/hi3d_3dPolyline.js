(function(global) {
    ...
    if (fabric.Hi3DPolyline) {
      fabric.warn('fabric.Hi3DPolyline is already defined');
      return;
    }
...
fabric.Hi3DPolyline = fabric.util.createClass(fabric.Polyline, {
  ...
  fabric.Hi3DPolyline.fromObject = function (object, callback) {
    callback && callback(new fabric.Hi3DPolyline(object.points, object));
  };
  
  fabric.Hi3DPolyline.async = true;

  fabric.Hi3DPolyline.prototype.controlsGenerator = function (polyline) {
  ...
  fabric.Hi3DPolyline.prototype.polylineAddPoints = function (polyline) {
    // custom control
...
hiDraw.prototype.Hi3DPolyline = (function () {
    ...
    Polyline.prototype.generatePolyline = function (pointArray) {
        ...
        Polyline.hiId = new Date().getTime()
        Polyline.altitude = 0
