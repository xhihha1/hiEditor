(function (global) {
    ...
    if (fabric.HiFormatFbx) {
      fabric.warn('fabric.HiFormatFbx is already defined');
      return;
    }
  
    fabric.HiFormatFbx = fabric.util.createClass(fabric.Rect, {
    ...
    fabric.HiFormatFbx.fromObject = function (object, callback) {
      callback && callback(new fabric.HiFormatFbx(object));
    };
  
    fabric.HiFormatFbx.async = true;
  
    // ---------------------------------------
    fabric.HiFormatFbx.prototype.controls = {}
    fabric.HiFormatFbx.prototype.controls.tl = new fabric.Control({
      x: -0.5,
      y: -0.5,
    ...
    fabric.HiFormatFbx.prototype.controls.tr = new fabric.Control({
      x: 0.5,
      y: -0.5,
      // cursorStyleHandler: scaleStyleHandler,
      // actionHandler: wrapWithFireEvent('scaling', wrapWithFixedAnchor( scaleObject))
    ...
    fabric.HiFormatFbx.prototype.controls.bl = new fabric.Control({
      x: -0.5,
      y: 0.5,
      // cursorStyleHandler: scaleStyleHandler,
      // actionHandler: wrapWithFireEvent('scaling', wrapWithFixedAnchor( scaleObject))
    ...
    fabric.HiFormatFbx.prototype.controls.br = new fabric.Control({
      x: 0.5,
      y: 0.5,
      // cursorStyleHandler: scaleStyleHandler,
      // actionHandler: wrapWithFireEvent('scaling', wrapWithFixedAnchor( scaleObject))
    ...
    fabric.HiFormatFbx.prototype.controls.mtr = new fabric.Control({
      x: 0,
      y: -0.5,
    ...
    hiDraw.prototype.HiFormatFbx = (function () {
      ...
      Circle.prototype.onMouseDown = function (o) {
        ...
        // this.source = {}  // obj: url
        var ellipse = new fabric.HiFormatFbx(prop)
