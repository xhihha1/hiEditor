(function (global) {
  ...
  if (fabric.HiPointLight) {
    fabric.warn('fabric.HiPointLight is already defined');
    return;
  }

  fabric.HiPointLight = fabric.util.createClass(fabric.Circle, {
  ...
  fabric.HiPointLight.fromObject = function (object, callback) {
    callback && callback(new fabric.HiPointLight(object));
  };

  fabric.HiPointLight.async = true;
  ...
  fabric.HiPointLight.prototype.transparentCorners = false;
  // fabric.HiPointLight.prototype.cornerColor = 'blue';
  // fabric.HiPointLight.prototype.cornerStyle = 'circle';

  fabric.HiPointLight.prototype.controls = {}
  fabric.HiPointLight.prototype.controls.upControl = new fabric.Control({
    x: 1,
    y: -1,
    offsetX: 10,
    offsetY: 10,
  ...
  fabric.HiPointLight.prototype.controls.downControl = new fabric.Control({
    x: 1,
    y: 0,
    offsetX: 10,
    offsetY: 10,
  ...
  hiDraw.prototype.HiPointLight = (function () {
    ...
    Circle.prototype.onMouseDown = function (o) {
      ...
      //     strokeUniform: true
      // });
      var ellipse = new fabric.HiPointLight({
        stroke: '#333333',
        strokeWidth: 2,
        fill: '#AA0000',
        opacity: 1,
