  ...
  hiDraw.prototype.viewEvent = (function () {
    var viewEvent = function () {
      ...
      this.canvasView.on('mouse:wheel', function (opt) {
        ...
        //     o.setCoords();
        // });
        if (that.defaultOptions.showGridAxis) {
          that.BgGrid(true)
        }
      ...
      if (document.getElementById(this.defaultOptions.canvasViewId) &&
        document.getElementById(this.defaultOptions.canvasViewId).parentNode &&
        document.getElementById(this.defaultOptions.canvasViewId).parentNode.parentNode) {
